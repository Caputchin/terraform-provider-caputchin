...
description: |-
  Manage Caputchin teams, site keys, per-site configuration, and read account / stats data.
---
...
- `management_token` (String, Sensitive) Caputchin management API token (account-PAT or team-PAT). May be supplied via the CAPUTCHIN_MANAGEMENT_TOKEN environment variable.
