...
subcategory: ""
description: |-
  A Caputchin site key — the public/secret pair a customer embeds in their site and uses to verify users. team_id is immutable; changing it forces replacement.
---
...
- `team_id` (String) Identifier of the owning team. Immutable — changing this attribute forces replacement of the site key.
...
- `tier` (String) Plan tier inherited from the owning team. Read-only.
